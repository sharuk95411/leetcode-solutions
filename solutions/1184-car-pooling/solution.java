class Solution {
    public boolean carPooling(int[][] trips, int capacity) {
        ...
        for (int trip[] : trips){
    lengthOfTrip[trip[1]] = lengthOfTrip[trip[1]]+ trip[0]; // Increment when passenger is on board
    lengthOfTrip[trip[2]] = lengthOfTrip[trip[2]]-trip[0]; // decrement when they depart
        }
        ...
        for (int i = 0; i < 1001; i++){
            carLoad =carLoad+ lengthOfTrip[i];
